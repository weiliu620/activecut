...
~/projects/group_mrf_lemon/build_${myhost}/groupmrf --nthreads 100 --sweepperthread 1 --burnin 20 --numSamples 10 --emiter 30 --alpha 3 --beta 0.8 --gamma 1 -k 7 --inittemp 0.1 --finaltemp 0.1  --initsame -i ${initgrpimage}  -f  ${session_dir}/allfunc_normalized --cumusampledir ${session_dir}/${test_dir}/cumusamples --rsampledir ${session_dir}/${test_dir}/rsamples --verbose 2
