...
# Use 6 neighborhood system. temperature  = 1.0
myhost=`hostname`
session_dir=$1
initgrpimage=$2
test_dir=test3e
...
~/projects/group_mrf_lemon/build_${myhost}/groupmrf6 --nthreads 300 --sweepperthread 1 --burnin 20 --numSamples 100 --emiter 30 --alpha 1 --beta 5 --gamma 1 -k 7 --inittemp 1.0 --finaltemp 1.0 --initsame -i ${initgrpimage}  -f  ${session_dir}/allfunc_normalized --cumusampledir ${session_dir}/${test_dir}/cumusamples --rsampledir ${session_dir}/${test_dir}/rsamples
