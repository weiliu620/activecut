...
~/projects/mcem_lemon/build_${myhost}/mcem_lemon --burnin 20 --numSamples 50 --emiter 30 --beta 10 --gamma 1 -k 7 --inittemp 1 --finaltemp 1  -i ${initlabelmap}  -f  ${session_dir}/func_sphere.nii.gz --cumusample ${session_dir}/${test_dir}/cumusample.nii.gz --rsample ${session_dir}/${test_dir}/rsample.nii.gz -v 3
