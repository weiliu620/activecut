...
int main(int argc, char* argv[])
{
     ...
     mydesc.add_options()
	  ...
	  ("initsame", po::bool_switch(&initsame), "whether to init subject same to group label.")
     ...
     for (unsigned short emIterIdx = 0; emIterIdx < EMIter; emIterIdx ++) {
	  ...
	  // Plot Q function vs betaz.
	  // mcmodel.PlotQvsBeta(sampleVec, grpVec, maskPtr, fmriVec);
	  ...
	  // estimate alpha, beta.
	  if (estprior) {
	       mcmodel.EstimatePriorPar(sampleVec, grpVec, maskPtr, par.alpha0, par.sigma2);
	  }
