...
for (i in length(fmriData$filenames)) {
  Data[,(i-1) * ncol(fmriData$Y) + 1: i * ncol(fmriDataY)] <- data[(i-1) * nrow(fmriData$Y) / length(fmriData$filenames): i * nrow(fmriData$Y) / length(fmriData$filenames),]
}
