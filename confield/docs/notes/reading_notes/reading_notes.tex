...
\begin{itemize}
  ...
  \item Rich method for optimization.
  \item Network analysis as postprocessing.
  \item Possibility to parallelize} The graphical Lasso problem can be seen as
    $P$ independent linear regression problem, which can be parallelized.
\end{itemize}
